...
class FindGroupsTableViewController: UITableViewController {
    ...
    private func generateGroups() {
        let group1 = Group(name: "Лентач", groupAvatar: "imagegroup2")
        let group2 = Group(name: "Netflix", groupAvatar: "imagegroup3")
        let group3 = Group(name: "Nintendo Россия", groupAvatar: "imagegroup1")
